...
def train_and_evaluate(dataloader, model, criterion, optimizer, num_epochs, writer, test_dataloader):
    ...
    for epoch in range(num_epochs):
        ...
        # Save the model
        model_save_path = f"runs_FFBC_model_epoch_{epoch + 31}.pth"
...
def main():
    ...
    pretrained_path = "runs_FFBC_model_epoch_30.pth"
    ...
    if pretrained_path is not None:
        ...
        # for key in list(pretrained_model.keys()):
        #     pretrained_model[key.replace("model.", "")] = pretrained_model.pop(key)
