...
def main():
    model = FFBC()
    model.load_state_dict(torch.load("/home/dev/workspace/metalman/metalman_core/src/metalman_core/insertion/RL/abs_pos_expert_wrench_100s/runs_FFBC_model_epoch_70.pth"))
    model.eval()
    ...
    for _, labels in test_loader:
        ...
        # print(actual_labels)
    """ 
    Actual labels is a list timestep (1227) of ndarray (1, 1300) -> 1300 is just action over the next 100 timesteps flattened. So it is x,y,z,qx,qy,qz,qw over 100 timesteps
    Plot actual labels 
    """
