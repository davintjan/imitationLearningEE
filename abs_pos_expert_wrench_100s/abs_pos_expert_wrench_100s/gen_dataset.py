    ...
    def _read_from_pickle(self, path):
        with open(path, 'rb') as file:
            ...
            trajectory = {
                ...
                'obs_pose': actual_rel_pose  # List of N timesteps x 6 (assuming wrench data has 6 components)
            }
...
if __name__ == "__main__":
    ...
    #
    # c = dataset.__getitem__(6)
    # d = dataset.__getitem__(13)
    # e = dataset.__getitem__(20)
    # f = dataset.__getitem__(800)
    g = dataset.__getitem__(100)
    print(g[0].shape, g[1].shape)
    # h = dataset.__getitem__(3103)
    # i = dataset.__getitem__(3105)
    # j = dataset.__getitem__(3104)
    # k = dataset.__getitem__(820)
